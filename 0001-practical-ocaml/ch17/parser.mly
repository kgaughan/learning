...
%token L_BRAKET R_BRAKET SHARP HEARTBEAT CONNECTED
...
time_and_server:
| TIME L_BRAKET SERVER R_BRAKET {
  { Mll_types.date = $1; Mll_types.host = $3 }
}
;

heartbeat:
| time_and_server HEARTBEAT IP_ADDR {
  Mll_types.Heartbeat ($1, Mll_types.Peer $3)
}
;

connected:
| time_and_server CONNECTED CLIENT SHARP NUMBER PORT NUMBER MESSAGE {
  Mll_types.Connected ($1, Mll_types.Client { Mll_types.c_id = $5; Mll_types.c_port = Mll_types.Port $7}, $8)
}
| time_and_server CONNECTED CLIENT SHARP NUMBER PORT NUMBER SLASH NUMBER ADDR MESSAGE {
  Mll_types.Connected ($1, Mll_types.Client { Mll_types.c_id = $5; Mll_types.c_port = Mll_types.Siteport ($7, $9, $10)}, $11)
}
...
| time_and_server COMMAND CLIENT SHARP NUMBER PORT NUMBER SLASH NUMBER ADDR MESSAGE {
  Mll_types.Command ($1, {Mll_types.c_id = $5; Mll_types.c_port = Mll_types.Siteport ($7, $9, $10)}, $11)
}
| time_and_server COMMAND CLIENT SHARP NUMBER PORT NUMBER MESSAGE {
  Mll_types.Command ($1, {Mll_types.c_id = $5; Mll_types.c_port = Mll_types.Port $7}, $8)
}
;
...
| time_and_server DISCONNECTED CLIENT SHARP NUMBER PORT NUMBER MESSAGE {
  Mll_types.Disconnect ($1, Mll_types.Client {Mll_types.c_id = $5; Mll_types.c_port = Mll_types.Port $7}, $8)
}
| time_and_server DISCONNECTED CLIENT SHARP NUMBER PORT NUMBER SLASH NUMBER ADDR MESSAGE {
  Mll_types.Disconnect ($1, Mll_types.Client {Mll_types.c_id = $5; Mll_types.c_port = Mll_types.Siteport ($7, $9, $10)}, $11)
}
;
